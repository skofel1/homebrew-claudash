...
class Claudash < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/skofel1/claudash/releases/download/v1.6.0/claudash_1.6.0_darwin_amd64.tar.gz"
      sha256 "8a44606af2e0485bb8d908db43c20e7dfa2e295d32908db3c64d2fbe4128c906"
    end
    on_arm do
      url "https://github.com/skofel1/claudash/releases/download/v1.6.0/claudash_1.6.0_darwin_arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/skofel1/claudash/releases/download/v1.6.0/claudash_1.6.0_linux_amd64.tar.gz"
      sha256 "40461ddbdb7860d4429b3465c95d09ea58a63d97bdc4e826b912db9ad08a01ef"
    end
    on_arm do
      url "https://github.com/skofel1/claudash/releases/download/v1.6.0/claudash_1.6.0_linux_arm64.tar.gz"
